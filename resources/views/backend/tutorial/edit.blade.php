            ...
            <form action="{{ route('tutorials.update',@$tutorial->id) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3 login-field">
                        ...
                        <input type="text" name="title" id="title" value="{{@$tutorial->title ?? old('title') }}"
                    ...
                    <div class="col-12 mb-3 login-field">
                        ...
                        <input type="text" name="url" id="url" value="{{@$tutorial->url ?? old('url') }}"
                    ...
                    <div class="form-check form-switch d-flex align-items-center gap-2 languge-content mb-3">
                        <div>
                            <input class="form-check-input language-btn ms-0 mt-0" name="status" type="checkbox"
                                role="switch" {{@$tutorial->status == 1 ? 'checked' : ''}}/>
                        </div>
                        <p class="">Status</p>
                    </div>
                    <!--status end-->
